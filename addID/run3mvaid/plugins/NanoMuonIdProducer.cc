...
// 
// NanoMuonIdProducer is designed for Bs/d->mumu analysis
//
...
class NanoMuonIdProducer : public edm::stream::EDProducer<> {
    
public:
    
  explicit NanoMuonIdProducer(const edm::ParameterSet &iConfig);
    
  ~NanoMuonIdProducer() override {};
...
NanoMuonIdProducer::NanoMuonIdProducer(const edm::ParameterSet &iConfig):
...
void NanoMuonIdProducer::fillSoftMva(pat::CompositeCandidate& mu_cand){
  // "match2_pullDyDz"
  // "match1_pullDyDz"
  // "match2_pullDxDz"
  // "match1_pullDxDz"
...
const l1t::Muon* NanoMuonIdProducer::getL1Muon( const reco::Candidate& cand, float max_dr){
...
void NanoMuonIdProducer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
...
void NanoMuonIdProducer::fillMatchInfo(pat::CompositeCandidate& cand,
				      const pat::Muon& muon){
...
DEFINE_FWK_MODULE(NanoMuonIdProducer);
