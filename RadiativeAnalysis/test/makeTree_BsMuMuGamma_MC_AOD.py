...
process.CUDAService = cms.Service("CUDAService", enabled = cms.untracked.bool(False))
process.AlpakaServiceCudaAsync = cms.Service("AlpakaServiceCudaAsync", enabled = cms.untracked.bool(False))
