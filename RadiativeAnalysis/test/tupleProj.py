...
analysisTag = "JpsiGEndMarch"
tupleName = "tOut"

# Prepare a directory for the output histograms
dirPath = 'tupleProjections/'+analysisTag+'/cut_5'
os.mkdir(dirPath)
...
cutList.append(r.TCut("fittedDimuonVertexProbCut","fittedDimuonVertexProb > 0.3"))
...
cutList.append(r.TCut("cosAngleBsBSpot2DCut","cosAngleBsBSpot2D > 0.95"))
