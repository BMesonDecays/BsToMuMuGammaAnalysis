      ...
      for(size_t i =0 ; i<tracks.size(); i++){
          ...
          for(size_t j = i+1 ; j<tracks.size(); j++){
              ...
              rrt->BsVtxProb_mmkk_ = BCandFitter.getBhadronProb();
                ...
                rrt->BsCt3D_mmkk_ = VariableDefinitions::calculateCt3D(PVlowestDCA, bVertex, bs);

                rrt->VertexfitBsCtErr3D_mmkk_ = VariableDefinitions::calculateCt3DError(PVlowestDCA, bVertex, bs);
                
                rrt->BsCt2D_mmkk_ = VariableDefinitions::calculateCt2D(PVlowestDCA, bVertex, bs);

                rrt->VertexfitBsCtErr2D_mmkk_ = VariableDefinitions::calculateCt2DError(PVlowestDCA, bVertex, bs);
