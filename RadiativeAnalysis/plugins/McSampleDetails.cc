...
//object definition
class McSampleDetails : public edm::one::EDAnalyzer<> {
public:

  //constructor, function is called when new object is created
  explicit McSampleDetails(const edm::ParameterSet& conf);
...
McSampleDetails::McSampleDetails(const edm::ParameterSet& conf)
...
McSampleDetails::~McSampleDetails()
{
  cout <<" DTOR" << endl;
}
...
void McSampleDetails::analyze(
    const edm::Event& ev, const edm::EventSetup& es)
{
  std::cout << " -------------------------------- HERE McSampleDetails::analyze "<< std::endl;
...
DEFINE_FWK_MODULE(McSampleDetails);