...
//object definition
class fullFitJpsiG_MC : public edm::one::EDAnalyzer<> {
public:

  //constructor, function is called when new object is created
  explicit fullFitJpsiG_MC(const edm::ParameterSet& conf);
...
fullFitJpsiG_MC::fullFitJpsiG_MC(const edm::ParameterSet& conf)
...
fullFitJpsiG_MC::~fullFitJpsiG_MC()
{
  cout <<" DTOR" << endl;
}

void fullFitJpsiG_MC::beginJob()
{
 
  cout << "HERE fullFitJpsiG_MC::beginJob()" << endl;
}

void fullFitJpsiG_MC::endJob()
{
  ...
  cout << "HERE fullFitJpsiG_MC::endJob()" << endl;
}

void fullFitJpsiG_MC::analyze(
    const edm::Event& ev, const edm::EventSetup& es)
{
  std::cout << " -------------------------------- HERE fullFitJpsiG_MC::analyze "<< std::endl;
  ...
  ///////KINEMATIC FIT WITH POINTING CONSTRAINT///////////////
...
DEFINE_FWK_MODULE(fullFitJpsiG_MC);
