...
//object definition
class JpsiGStartApril_MC : public edm::one::EDAnalyzer<> {
public:

  //constructor, function is called when new object is created
  explicit JpsiGStartApril_MC(const edm::ParameterSet& conf);
...
JpsiGStartApril_MC::JpsiGStartApril_MC(const edm::ParameterSet& conf)
...
JpsiGStartApril_MC::~JpsiGStartApril_MC()
{
  cout <<" DTOR" << endl;
}

void JpsiGStartApril_MC::beginJob()
{
...
void JpsiGStartApril_MC::endJob()
{
  ...
  cout << "HERE JpsiGStartApril_MC::endJob()" << endl;
}

void JpsiGStartApril_MC::analyze(
    const edm::Event& ev, const edm::EventSetup& es)
{
  std::cout << " -------------------------------- HERE JpsiGStartApril_MC::analyze "<< std::endl;
...
DEFINE_FWK_MODULE(JpsiGStartApril_MC);