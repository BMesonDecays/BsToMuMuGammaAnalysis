...
//object definition
class countEvents : public edm::one::EDAnalyzer<> {
public:

  //constructor, function is called when new object is created
  explicit countEvents(const edm::ParameterSet& conf);
...
countEvents::countEvents(const edm::ParameterSet& conf)
