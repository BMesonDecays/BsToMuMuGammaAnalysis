...
void RadiativeRootTree::createTree(const std::string filename)
{
  ...
  bmmgTree_->Branch("trigMatch_DoubleMu4_3_Bs", &trigMatch_DoubleMu4_3_Bs_); 
  bmmgTree_->Branch("trigMatch_DoubleMu4_3_Jpsi", &trigMatch_DoubleMu4_3_Jpsi_); 
  bmmgTree_->Branch("trigMatch_DoubleMu4_3_LowMass", &trigMatch_DoubleMu4_3_LowMass_); 
  bmmgTree_->Branch("trigMatch_DoubleMu4_LowMass_Displaced", &trigMatch_DoubleMu4_LowMass_Displaced_); 
  bmmgTree_->Branch("trigMatch_DoubleMu4_3_Photon4_BsToMMG", &trigMatch_DoubleMu4_3_Photon4_BsToMMG_);
  bmmgTree_->Branch("trigMatch_DoubleMu4_3_Displaced_Photon4_BsToMMG",&trigMatch_DoubleMu4_3_Displaced_Photon4_BsToMMG_); 
  bmmgTree_->Branch("trigMatch_DoubleMu4_JpsiTrkTrk_Displaced", &trigMatch_DoubleMu4_JpsiTrkTrk_Displaced_);
  bmmgTree_->Branch("trigMatch_DoubleMu4_Jpsi_NoVertexing", &trigMatch_DoubleMu4_Jpsi_NoVertexing_);
  bmmgTree_->Branch("trigMatch_DoubleMu4_Jpsi_Displaced", &trigMatch_DoubleMu4_Jpsi_Displaced_);
...
bmmgTree_->Branch("DiMuonPt_NoBound", &DiMuonPt_NoBound_, "DiMuonPt_NoBound/D");
  ...
  bmmgTree_->Branch("Mu1_genGMotherPdgId", &Mu1_genGMotherPdgId_,"Mu1_genGMotherPdgId/I");
...
void RadiativeRootTree::setBranchAddresses(){
  ...
  bmmgTree_->SetBranchAddress("trigMatch_DoubleMu4_3_Bs",&trigMatch_DoubleMu4_3_Bs_);
  bmmgTree_->SetBranchAddress("trigMatch_DoubleMu4_3_Jpsi",&trigMatch_DoubleMu4_3_Jpsi_);
  bmmgTree_->SetBranchAddress("trigMatch_DoubleMu4_3_LowMass",&trigMatch_DoubleMu4_3_LowMass_);
  bmmgTree_->SetBranchAddress("trigMatch_DoubleMu4_LowMass_Displaced",&trigMatch_DoubleMu4_LowMass_Displaced_);
  bmmgTree_->SetBranchAddress("trigMatch_DoubleMu4_3_Photon4_BsToMMG",&trigMatch_DoubleMu4_3_Photon4_BsToMMG_);
  bmmgTree_->SetBranchAddress("trigMatch_DoubleMu4_3_Displaced_Photon4_BsToMMG",&trigMatch_DoubleMu4_3_Displaced_Photon4_BsToMMG_);
  bmmgTree_->SetBranchAddress("trigMatch_DoubleMu4_JpsiTrkTrk_Displaced",&trigMatch_DoubleMu4_JpsiTrkTrk_Displaced_);
  bmmgTree_->SetBranchAddress("trigMatch_DoubleMu4_Jpsi_NoVertexing", &trigMatch_DoubleMu4_Jpsi_NoVertexing_);
  bmmgTree_->SetBranchAddress("trigMatch_DoubleMu4_Jpsi_Displaced", &trigMatch_DoubleMu4_Jpsi_Displaced_);
