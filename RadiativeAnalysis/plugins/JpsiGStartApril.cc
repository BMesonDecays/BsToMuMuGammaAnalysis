// based on JpsiGEndMarch
// started on April 2 2026
...
//object definition
class JpsiGStartApril : public edm::one::EDAnalyzer<> {
public:

  //constructor, function is called when new object is created
  explicit JpsiGStartApril(const edm::ParameterSet& conf);
...
JpsiGStartApril::JpsiGStartApril(const edm::ParameterSet& conf)
...
void JpsiGStartApril::endJob()
{
  ...
  cout << "HERE JpsiGStartApril::endJob()" << endl;
}

void JpsiGStartApril::analyze(
    const edm::Event& ev, const edm::EventSetup& es)
{
  std::cout << " -------------------------------- HERE JpsiGStartApril::analyze "<< std::endl;
...
DEFINE_FWK_MODULE(JpsiGStartApril);